Config = {
    ...
    -- [[ เพิ่มใหม่: ระบบลบพืชที่เน่าเสียอัตโนมัติ (Auto Delete) ]]
    AutoDelete = {
        Enabled = true,        -- เปิดใช้งานระบบลบอัตโนมัติ
        LifeTimeHours = 15,    -- อายุของพืช (ชั่วโมง) ถ้าเกินนี้จะถูกลบออกจาก DB (72 ชม. = 3 วัน)
        CheckInterval = 1     -- ตรวจสอบทุกๆ กี่นาที (แนะนำ 60 นาที)
    },
    -----------------------------------------------------
